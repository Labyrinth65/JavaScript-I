...
console.log(`Car 33 is a ${inventory.filter((el) => el.id === 33)[0].car_year} ${inventory.filter((el) => el.id === 33)[0].car_make} ${inventory.filter((el) => el.id === 33)[0].car_model}`); 
